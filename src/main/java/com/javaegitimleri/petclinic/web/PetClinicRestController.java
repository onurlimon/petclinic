...
public class PetClinicRestController {
	...
	public ResponseEntity<?> updateOwner(@PathVariable("id") Long id ,@RequestBody Owner ownerRequest){
		try {
			Owner owner = petClinicService.findOwner(id);
			owner.setFirstName("Esen");
			owner.setLastName("Limon");
	...
	public ResponseEntity<?> getOwnerAsHateoasResource(@PathVariable("id") Long id){
		...
		try {
			...
			Link update = ControllerLinkBuilder.linkTo(PetClinicService.class).slash("owner/" + id).withRel("update");
			Link delete = ControllerLinkBuilder.linkTo(PetClinicService.class).slash("/owner/" + id).withRel("delete");
