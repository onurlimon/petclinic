...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers("/**/favicon.ico","/rest/**","/css/**","/js/**","/images/**","/webjars/**","/login.html").permitAll();
		//http.authorizeRequests().antMatchers("/rest/**").access("hasRole('USER')"); 
